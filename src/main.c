...
int hc05_server_init(void) {
	...
	usart_send_command(USART0, buffer_rx, 1000, "AT", 1000);	
	usart_send_command(USART0, buffer_rx, 1000, "AT+NAMEManuTopzera", 1000);		//AT+NAMEnomedesejado
	usart_log("hc05_server_init", buffer_rx);
	usart_send_command(USART0, buffer_rx, 1000, "AT", 1000);
	usart_send_command(USART0, buffer_rx, 1000, "AT+PIN0011", 1000);			//AT+PINpindesejado	
	usart_log("hc05_server_init", buffer_rx);
}
